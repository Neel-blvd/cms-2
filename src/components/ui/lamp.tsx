  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="text-black text-center font-bold text-3xl tracking-tight md:text-5xl"
      >
        Manage your cases 
        <br /> 
        the right way
